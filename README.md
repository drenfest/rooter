...
### Mac
https://nodejs.org/dist/v10.15.0/node-v10.15.0.pkg
...
```
---
##  Install Nuxt And Create-Nuxt-App Globally
```npm
npm i -g nuxt
...
```
---
For detailed explanation on how things work with Nuxtjs, checkout [Nuxt.js docs](https://nuxtjs.org).
